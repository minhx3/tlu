...
subjectClassTeacherFromJson(
    SubjectClassTeacher data, Map<String, dynamic> json) {
  if (json['avatar'] != null) {
...
subjectClassTeacherTeachingListFromJson(
    SubjectClassTeacherTeachingList data, Map<String, dynamic> json) {
...
Map<String, dynamic> subjectClassTeacherTeachingListToJson(
    SubjectClassTeacherTeachingList entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
subjectClassSemesterFromJson(
    SubjectClassSemester data, Map<String, dynamic> json) {
