...
registerSubjectEntityFromJson(
    RegisterSubjectEntity data, Map<String, dynamic> json) {
  ...
  if (json['listTeacher'] != null) {
    data.listTeacher = (json['listTeacher'] as List)
        .map((v) => RegisterSubjectListTeacher().fromJson(v))
        .toList();
  }
  if (json['listTimelineClass'] != null) {
    data.listTimelineClass = (json['listTimelineClass'] as List)
        .map((v) => RegisterSubjectListTimelineClassTimeLines().fromJson(v))
        .toList();
  }
  if (json['note'] != null) {
  ...
  if (json['numberOfLessons'] != null) {
    data.numberOfLessons = (json['numberOfLessons'] as List)
        .map((v) => RegisterSubjectNumberOfLessons().fromJson(v))
        .toList();
  }
  if (json['optionListBook'] != null) {
    data.optionListBook = (json['optionListBook'] as List)
  ...
  if (json['prerequisiteSubject'] != null) {
    data.prerequisiteSubject = RegisterSubjectPrerequisiteSubject()
        .fromJson(json['prerequisiteSubject']);
  }
  if (json['requiredListBook'] != null) {
    data.requiredListBook = (json['requiredListBook'] as List)
...
Map<String, dynamic> registerSubjectEntityToJson(RegisterSubjectEntity entity) {
  ...
  data['listTimelineClass'] =
      entity.listTimelineClass?.map((v) => v.toJson())?.toList();
  data['note'] = entity.note;
  data['numberOfLessons'] =
      entity.numberOfLessons?.map((v) => v.toJson())?.toList();
  data['optionListBook'] =
      entity.optionListBook?.map((v) => v.toJson())?.toList();
  data['population'] = entity.population;
  data['prerequisiteSubject'] = entity.prerequisiteSubject?.toJson();
  data['requiredListBook'] =
      entity.requiredListBook?.map((v) => v.toJson())?.toList();
...
registerSubjectListTimelineClassFromJson(
    RegisterSubjectListTimelineClass data, Map<String, dynamic> json) {
  if (json['code'] != null) {
    data.code = json['code'].toString();
  }
  if (json['teacher'] != null) {
    data.teacher =
        RegisterSubjectListTimelineClassTeacher().fromJson(json['teacher']);
  }
  if (json['timeLines'] != null) {
    data.timeLines = (json['timeLines'] as List)
        .map((v) => RegisterSubjectListTimelineClassTimeLines().fromJson(v))
        .toList();
  }
  return data;
...
Map<String, dynamic> registerSubjectListTimelineClassToJson(
    RegisterSubjectListTimelineClass entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectListTimelineClassTeacherFromJson(
  ...
  if (json['teachingList'] != null) {
    data.teachingList = (json['teachingList'] as List)
        .map((v) =>
            RegisterSubjectListTimelineClassTeacherTeachingList().fromJson(v))
        .toList();
  }
  return data;
}
...
registerSubjectListTimelineClassTimeLinesFromJson(
    RegisterSubjectListTimelineClassTimeLines data, Map<String, dynamic> json) {
  ...
  if (json['listSchedule'] != null) {
    data.listSchedule = (json['listSchedule'] as List)
        .map((v) =>
            RegisterSubjectListTimelineClassTimeLinesListSchedule().fromJson(v))
        .toList();
  }
  if (json['toDate'] != null) {
...
Map<String, dynamic> registerSubjectListTimelineClassTimeLinesToJson(
    RegisterSubjectListTimelineClassTimeLines entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectListTimelineClassTimeLinesListScheduleFromJson(
    RegisterSubjectListTimelineClassTimeLinesListSchedule data,
    Map<String, dynamic> json) {
  ...
  if (json['listSession'] != null) {
    data.listSession = (json['listSession'] as List)
        .map((v) =>
...
Map<String, dynamic>
    registerSubjectListTimelineClassTimeLinesListScheduleToJson(
        RegisterSubjectListTimelineClassTimeLinesListSchedule entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectListTimelineClassTimeLinesListScheduleListSessionFromJson(
    RegisterSubjectListTimelineClassTimeLinesListScheduleListSession data,
    Map<String, dynamic> json) {
  ...
  if (json['startTime'] != null) {
    data.startTime =
        RegisterSubjectListTimelineClassTimeLinesListScheduleListSessionStartTime()
            .fromJson(json['startTime']);
  }
  return data;
}

Map<String, dynamic>
    registerSubjectListTimelineClassTimeLinesListScheduleListSessionToJson(
        RegisterSubjectListTimelineClassTimeLinesListScheduleListSession
            entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectListTimelineClassTimeLinesListScheduleListSessionEndTimeFromJson(
    RegisterSubjectListTimelineClassTimeLinesListScheduleListSessionEndTime
        data,
    Map<String, dynamic> json) {
  if (json['hours'] != null) {
...
Map<String, dynamic>
    registerSubjectListTimelineClassTimeLinesListScheduleListSessionEndTimeToJson(
        RegisterSubjectListTimelineClassTimeLinesListScheduleListSessionEndTime
            entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectListTimelineClassTimeLinesListScheduleListSessionStartTimeFromJson(
    RegisterSubjectListTimelineClassTimeLinesListScheduleListSessionStartTime
        data,
    Map<String, dynamic> json) {
  if (json['hours'] != null) {
...
Map<String, dynamic>
    registerSubjectListTimelineClassTimeLinesListScheduleListSessionStartTimeToJson(
        RegisterSubjectListTimelineClassTimeLinesListScheduleListSessionStartTime
            entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['hours'] = entity.hours;
...
registerSubjectNumberOfLessonsFromJson(
    RegisterSubjectNumberOfLessons data, Map<String, dynamic> json) {
...
Map<String, dynamic> registerSubjectNumberOfLessonsToJson(
    RegisterSubjectNumberOfLessons entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectOptionListBookFromJson(
    RegisterSubjectOptionListBook data, Map<String, dynamic> json) {
  if (json['author'] != null) {
...
Map<String, dynamic> registerSubjectOptionListBookToJson(
    RegisterSubjectOptionListBook entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectPrerequisiteSubjectFromJson(
    RegisterSubjectPrerequisiteSubject data, Map<String, dynamic> json) {
  if (json['credits'] != null) {
    data.credits = json['credits'] is String
        ? int.tryParse(json['credits'])
        : json['credits'].toInt();
...
Map<String, dynamic> registerSubjectPrerequisiteSubjectToJson(
    RegisterSubjectPrerequisiteSubject entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['credits'] = entity.credits;
  data['description'] = entity.description;
  data['factor'] = entity.factor;
...
registerSubjectRequiredListBookFromJson(
    RegisterSubjectRequiredListBook data, Map<String, dynamic> json) {
  if (json['author'] != null) {
    data.author = json['author'].toString();
  }
  if (json['id'] != null) {
...
Map<String, dynamic> registerSubjectRequiredListBookToJson(
    RegisterSubjectRequiredListBook entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['author'] = entity.author;
  data['id'] = entity.id;
  data['link'] = entity.link;
...
registerSubjectSemesterFromJson(
    RegisterSubjectSemester data, Map<String, dynamic> json) {
  if (json['endTime'] != null) {
...
Map<String, dynamic> registerSubjectSemesterToJson(
    RegisterSubjectSemester entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
registerSubjectSubjectIdFromJson(
    RegisterSubjectSubjectId data, Map<String, dynamic> json) {
  if (json['credits'] != null) {
    data.credits = json['credits'] is String
        ? int.tryParse(json['credits'])
        : json['credits'].toInt();
...
Map<String, dynamic> registerSubjectSubjectIdToJson(
    RegisterSubjectSubjectId entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['credits'] = entity.credits;
  data['description'] = entity.description;
  data['factor'] = entity.factor;
