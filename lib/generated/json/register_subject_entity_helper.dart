...
registerSubjectEntityFromJson(
  ...
  if (json['isOnline'] != null) {
    data.isOnline = (json['isOnline'] is String)
        ? json['isOnline'] == "true"
        : json['isOnline'];
  }
  if (json['group'] != null) {
  ...
  if (json['listTeacher'] != null) {
    data.listTeacher =
        (json['listTeacher'] as List).map((v) => Teacher.fromJson(v)).toList();
  }
  ...
  if (json['subject'] != null) {
    data.subject = RegisterSubjectSubject().fromJson(json['subject']);
  }
  return data;
}
...
registerSubjectListTimelineClassFromJson(
  ...
  if (json['teacher'] != null) {
    data.teacher = Teacher.fromJson(json['teacher']);
  }
...
registerSubjectSubjectIdFromJson(
    RegisterSubjectSubject data, Map<String, dynamic> json) {
  if (json['credits'] != null) {
    data.credits = json['credits'] is String
        ? int.tryParse(json['credits'])
        : json['credits'].toInt();
